    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>Find restaurants near you</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          <MapPin size={80} color="#E2E8F0" />
          <Text style={styles.comingSoonTitle}>Map View Coming Soon</Text>
          <Text style={styles.comingSoonText}>
            We're working on bringing you an interactive map to discover restaurants in your area.
          </Text>
        </View>
      </View>
    </SafeAreaView>
