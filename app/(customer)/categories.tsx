    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>Browse restaurant categories</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          <Grid3x3 size={80} color="#E2E8F0" />
          <Text style={styles.comingSoonTitle}>Categories Coming Soon</Text>
          <Text style={styles.comingSoonText}>
            We're working on bringing you organized restaurant categories to help you find exactly what you're craving.
          </Text>
        </View>
      </View>
    </SafeAreaView>
