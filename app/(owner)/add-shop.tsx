    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>Create your restaurant listing</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          ...
          <Text style={styles.comingSoonTitle}>Add Restaurant Coming Soon</Text>
          <Text style={styles.comingSoonText}>
            We're working on bringing you an easy way to add and manage your restaurant listings.
          </Text>
        </View>
      </View>
    </SafeAreaView>
