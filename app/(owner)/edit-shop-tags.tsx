    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.headerTitle}>Edit Shop Tags</Text>
            <Text style={styles.headerSubtitle}>Manage your restaurant tags</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          <Tag size={80} color="#E2E8F0" />
          <Text style={styles.comingSoonTitle}>Tag Management Coming Soon</Text>
          <Text style={styles.comingSoonText}>
            We're working on bringing you an easy way to manage tags for your restaurant.
          </Text>
        </View>
      </View>
    </SafeAreaView>
