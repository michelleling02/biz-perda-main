      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>View your restaurant information</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          ...
          <Text style={styles.comingSoonText}>
            We're working on bringing you detailed views of your restaurant information and analytics.
          </Text>
        </View>
      </View>
    </SafeAreaView>
