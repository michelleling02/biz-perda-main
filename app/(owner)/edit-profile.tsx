...
import { User, CreditCard as Edit } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.comingSoon}>
          <User size={80} color="#E2E8F0" />
          <Text style={styles.comingSoonTitle}>Edit Profile Coming Soon</Text>
          <Text style={styles.comingSoonText}>
            We're working on bringing you an easy way to update your profile information.
          </Text>
        </View>
      </View>
    </SafeAreaView>
